...
Track.create([
    {album_id: 1, track_number: 1, duration: "2:41", title: "Come Back to Earth", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3"},
    {album_id: 1, track_number: 2, duration: "4:05", title: "Hurt Feelings", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-2.mp3"},
    {album_id: 1, track_number: 3, duration: "4:48", title: "What's the Use?", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-3.mp3"},
    {album_id: 1, track_number: 4, duration: "3:35", title: "Perfecto", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-4.mp3"},
    {album_id: 1, track_number: 5, duration: "5:45", title: "Self Care", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-5.mp3"},
    {album_id: 1, track_number: 6, duration: "4:10", title: "Wings", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-6.mp3"},
    {album_id: 1, track_number: 7, duration: "4:47", title: "Ladders", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-7.mp3"},
    {album_id: 1, track_number: 8, duration: "4:31", title: "Small Worlds", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-8.mp3"},
    {album_id: 1, track_number: 9, duration: "3:30", title: "Conversation, Pt. 1", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-9.mp3"},
    {album_id: 1, track_number: 10, duration: "3:57", title: "Dunno", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-10.mp3"},
    {album_id: 1, track_number: 11, duration: "5:45", title: "Jet Fuel", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-11.mp3"},
    {album_id: 1, track_number: 12, duration: "5:48", title: "2009", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-12.mp3"},
    {album_id: 1, track_number: 13, duration: "4:12", title: "So It Goes", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-13.mp3"},

    {album_id: 2, track_number: 1, duration: "2:50", title: "Circles", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3"},
    {album_id: 2, track_number: 2, duration: "3:52", title: "Complicated", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-2.mp3"},
    {album_id: 2, track_number: 3, duration: "3:29", title: "Blue World", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-3.mp3"},
    {album_id: 2, track_number: 4, duration: "5:42", title: "Good News", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-4.mp3"},
    {album_id: 2, track_number: 5, duration: "3:40", title: "I Can See", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-5.mp3"},
    {album_id: 2, track_number: 6, duration: "4:16", title: "Everybody", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-6.mp3"},
    {album_id: 2, track_number: 7, duration: "4:46", title: "Woods", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-7.mp3"},
    {album_id: 2, track_number: 8, duration: "4:58", title: "Hand Me Downs", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-8.mp3"},
    {album_id: 2, track_number: 9, duration: "3:37", title: "That's on Me", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-9.mp3"},
    {album_id: 2, track_number: 10, duration: "3:19", title: "Hands", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-10.mp3"},
    {album_id: 2, track_number: 11, duration: "5:30", title: "Surf", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-11.mp3"},
    {album_id: 2, track_number: 12, duration: "2:40", title: "Once a Day", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-12.mp3"},
    {album_id: 2, track_number: 13, duration: "4:47", title: "Right", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-13.mp3"},
    {album_id: 2, track_number: 14, duration: "4:14", title: "Floating", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-13.mp3"},

    {album_id: 3, track_number: 1, duration: "3:20", title: "Waiting On the World to Change", url: "/assets/music/01.wav"},
    {album_id: 3, track_number: 2, duration: "4:52", title: "I Don't Trust Myself (With Loving You)", url: "/assets/music/02.mp3"},
    {album_id: 3, track_number: 3, duration: "4:02", title: "Belief", url: "/assets/music/03.mp3"},
    {album_id: 3, track_number: 4, duration: "4:05", title: "Gravity", url: "/assets/music/04.mp3"},
    {album_id: 3, track_number: 5, duration: "3:19", title: "The Heart of Life", url: "/assets/music/05.mp3"},
    {album_id: 3, track_number: 6, duration: "4:11", title: "Vultures", url: "/assets/music/06.mp3"},
    {album_id: 3, track_number: 7, duration: "4:45", title: "Stop This Train", url: "/assets/music/07.mp3"},
    {album_id: 3, track_number: 8, duration: "4:01", title: "Slow Dancing In a Burning Room", url: "/assets/music/08.mp3"},
    {album_id: 3, track_number: 9, duration: "4:18", title: "Bold As Love", url: "/assets/music/09.mp3"},
    {album_id: 3, track_number: 10, duration: "4:07", title: "Dreaming With a Broken Heart", url: "/assets/music/10.mp3"},
    {album_id: 3, track_number: 11, duration: "6:09", title: "In Repair", url: "/assets/music/11.mp3"},
    {album_id: 3, track_number: 12, duration: "2:42", title: "I'm Gonna Find Another You", url: "/assets/music/01.wav"},
])
