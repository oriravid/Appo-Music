...
Artist.create([
    ...
    {name: "John Mayer", 
        ...
        url: "https://www.rollingstone.com/wp-content/uploads/2018/06/john-meyer-new-songs-55c5ef71-6d96-4575-adc3-56d0711a8345.jpg?resize=1800,1200&w=1800"},
    ...
    {name: "Chris Stapleton", 
        ...
        url: "https://www.gannett-cdn.com/-mm-/b99140ff27287701ca7cd014c3a7d3a1b4c8ba43/c=4-0-1397-787/local/-/media/2015/11/05/Louisville/Louisville/635823341588494542-chris-stapleton.jpg"},
    ...
    {name: "YUNGBLUD", 
        ...
        url: "https://www.morebiography.com/wp-content/uploads/2020/03/Yungblud.jpg"},
])
...
Album.create([
    ...
    {artist_id: 2, 
        ...
        url: "https://images-na.ssl-images-amazon.com/images/I/81Ir5odOasL._SL1500_.jpg",
    ...
    {artist_id: 2, 
        ...
        url: "https://images-na.ssl-images-amazon.com/images/I/51Cy2w3WzGL.jpg",
    ...
    {artist_id: 3, 
        ...
        url: "https://images-na.ssl-images-amazon.com/images/I/51WfgjLDaSL._SY400_.jpg",
...
Track.create([
    #1 - Circles
    {album_id: 1, track_number: 1, duration: "2:50", title: "Circles", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3"},
    {album_id: 1, track_number: 2, duration: "3:52", title: "Complicated", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-2.mp3"},
    {album_id: 1, track_number: 3, duration: "3:29", title: "Blue World", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-3.mp3"},
    {album_id: 1, track_number: 4, duration: "5:42", title: "Good News", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-4.mp3", play_count: 80},
    {album_id: 1, track_number: 5, duration: "3:40", title: "I Can See", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-5.mp3"},
    {album_id: 1, track_number: 6, duration: "4:16", title: "Everybody", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-6.mp3"},
    {album_id: 1, track_number: 7, duration: "4:46", title: "Woods", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-7.mp3"},
    {album_id: 1, track_number: 8, duration: "4:58", title: "Hand Me Downs", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-8.mp3"},
    {album_id: 1, track_number: 9, duration: "3:37", title: "That's on Me", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-9.mp3"},
    {album_id: 1, track_number: 10, duration: "3:19", title: "Hands", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-10.mp3"},
    {album_id: 1, track_number: 11, duration: "5:30", title: "Surf", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-11.mp3"},
    {album_id: 1, track_number: 12, duration: "2:40", title: "Once a Day", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-12.mp3"},
    {album_id: 1, track_number: 13, duration: "4:47", title: "Right", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-13.mp3"},
    {album_id: 1, track_number: 14, duration: "4:14", title: "Floating", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-13.mp3"},
    
    #2 - Swimming
    {album_id: 2, track_number: 1, duration: "2:41", title: "Come Back to Earth", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3"},
    {album_id: 2, track_number: 2, duration: "4:05", title: "Hurt Feelings", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-2.mp3", play_count: 70},
    {album_id: 2, track_number: 3, duration: "4:48", title: "What's the Use?", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-3.mp3"},
    {album_id: 2, track_number: 4, duration: "3:35", title: "Perfecto", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-4.mp3"},
    {album_id: 2, track_number: 5, duration: "5:45", title: "Self Care", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-5.mp3", play_count: 100},
    {album_id: 2, track_number: 6, duration: "4:10", title: "Wings", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-6.mp3"},
    {album_id: 2, track_number: 7, duration: "4:47", title: "Ladders", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-7.mp3", play_count: 50},
    {album_id: 2, track_number: 8, duration: "4:31", title: "Small Worlds", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-8.mp3"},
    {album_id: 2, track_number: 9, duration: "3:30", title: "Conversation, Pt. 1", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-9.mp3"},
    {album_id: 2, track_number: 10, duration: "3:57", title: "Dunno", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-10.mp3"},
    {album_id: 2, track_number: 11, duration: "5:45", title: "Jet Fuel", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-11.mp3"},
    {album_id: 2, track_number: 12, duration: "5:48", title: "2009", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-12.mp3", play_count: 90},
    ...
    {album_id: 4, track_number: 2, duration: "3:59", title: "Emoji of a Wave", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-2.mp3"},
    {album_id: 4, track_number: 3, duration: "4:09", title: "Helpless", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-3.mp3"},
    {album_id: 4, track_number: 4, duration: "3:32", title: "Love on the Weekend", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-4.mp3", play_count: 70},
    {album_id: 4, track_number: 5, duration: "4:04", title: "In the Blood", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-5.mp3", play_count: 50},
    {album_id: 4, track_number: 6, duration: "3:33", title: "Changing", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-6.mp3"},
    {album_id: 4, track_number: 7, duration: "1:54", title: "Theme from \"The Search for Everything\"", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-7.mp3"},
    {album_id: 4, track_number: 8, duration: "4:25", title: "Moving On and Getting Over", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-8.mp3"},
    {album_id: 4, track_number: 9, duration: "3:43", title: "Never on the Day You Leave", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-8.mp3"},
    {album_id: 4, track_number: 10, duration: "4:02", title: "Rosie", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-8.mp3"},
    {album_id: 4, track_number: 11, duration: "3:24", title: "Roll It on Home", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-8.mp3"},
    {album_id: 4, track_number: 12, duration: "3:10", title: "You're Gonna Live Forever in Me", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-8.mp3"},

    #5 - Battle Studies
    {album_id: 5, track_number: 1, duration: "4:29", title: "Heartbreak Warfare", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3", play_count: 30},
    {album_id: 5, track_number: 2, duration: "4:35", title: "All We Ever Do is Say Goodbye", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-2.mp3"},
    {album_id: 5, track_number: 3, duration: "4:10", title: "Half of My Heart", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-3.mp3", play_count: 40},
    {album_id: 5, track_number: 4, duration: "2:55", title: "Who Says", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-4.mp3", play_count: 50},
    {album_id: 5, track_number: 5, duration: "4:28", title: "Perfectly Lonely", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-5.mp3"},
    {album_id: 5, track_number: 6, duration: "5:14", title: "Assassin", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-6.mp3"},
    {album_id: 5, track_number: 7, duration: "2:29", title: "Crossroads", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-7.mp3"},
    {album_id: 5, track_number: 8, duration: "4:15", title: "War of My Life", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-8.mp3"},
    {album_id: 5, track_number: 9, duration: "5:31", title: "Edge of Desire", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-9.mp3"},
    {album_id: 5, track_number: 10, duration: "2:30", title: "Do You Know Me", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-9.mp3"},
    {album_id: 5, track_number: 11, duration: "5:59", title: "Friends, Lovers or Nothing", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-9.mp3"},

    #6 - Continuum
    {album_id: 6, track_number: 1, duration: "3:20", title: "Waiting On the World to Change", url: "/assets/music/01.mp3", play_count: 80},
    {album_id: 6, track_number: 2, duration: "4:52", title: "I Don't Trust Myself (With Loving You)", url: "/assets/music/02.mp3"},
    {album_id: 6, track_number: 3, duration: "4:02", title: "Belief", url: "/assets/music/03.mp3"},
    {album_id: 6, track_number: 4, duration: "4:05", title: "Gravity", url: "/assets/music/04.mp3", play_count: 100},
    {album_id: 6, track_number: 5, duration: "3:19", title: "The Heart of Life", url: "/assets/music/05.mp3"},
    {album_id: 6, track_number: 6, duration: "4:11", title: "Vultures", url: "/assets/music/06.mp3"},
    {album_id: 6, track_number: 7, duration: "4:45", title: "Stop This Train", url: "/assets/music/07.mp3"},
    {album_id: 6, track_number: 8, duration: "4:01", title: "Slow Dancing In a Burning Room", url: "/assets/music/08.mp3", play_count: 90},
    {album_id: 6, track_number: 9, duration: "4:18", title: "Bold As Love", url: "/assets/music/09.mp3"},
    {album_id: 6, track_number: 10, duration: "4:07", title: "Dreaming With a Broken Heart", url: "/assets/music/10.mp3", play_count: 60},
    {album_id: 6, track_number: 11, duration: "6:09", title: "In Repair", url: "/assets/music/11.mp3"},
    {album_id: 6, track_number: 12, duration: "2:42", title: "I'm Gonna Find Another You", url: "/assets/music/02.mp3"},

    #7 - Traveller
    {album_id: 7, track_number: 1, duration: "3:42", title: "Traveller", url: "/assets/music/01.mp3"},
    {album_id: 7, track_number: 2, duration: "4:04", title: "Fire Away", url: "/assets/music/02.mp3"},
    {album_id: 7, track_number: 3, duration: "4:53", title: "Tennessee Whiskey", url: "/assets/music/03.mp3", play_count: 200},
    {album_id: 7, track_number: 4, duration: "4:13", title: "Parachute", url: "/assets/music/04.mp3"},
    {album_id: 7, track_number: 5, duration: "3:56", title: "Whiskey and You", url: "/assets/music/05.mp3"},
    {album_id: 7, track_number: 6, duration: "4:04", title: "Nobody to Blame", url: "/assets/music/06.mp3"},
    {album_id: 7, track_number: 7, duration: "4:37", title: "More of You", url: "/assets/music/07.mp3"},
    {album_id: 7, track_number: 8, duration: "4:16", title: "When the Stars Come Out", url: "/assets/music/08.mp3"},
    {album_id: 7, track_number: 9, duration: "4:09", title: "Daddy Doesn't Pray Anymore", url: "/assets/music/09.mp3"},
    {album_id: 7, track_number: 10, duration: "4:37", title: "Might As Well Get Stoned", url: "/assets/music/10.mp3"},
    {album_id: 7, track_number: 11, duration: "4:49", title: "Was It 26", url: "/assets/music/11.mp3"},
    {album_id: 7, track_number: 12, duration: "6:07", title: "The Devil Named Music", url: "/assets/music/02.mp3"},
    {album_id: 7, track_number: 13, duration: "5:37", title: "Outlaw State of Mind", url: "/assets/music/02.mp3"},
    {album_id: 7, track_number: 14, duration: "4:00", title: "Sometimes I Cry", url: "/assets/music/02.mp3"},
